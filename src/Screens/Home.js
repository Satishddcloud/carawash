...
import { View, Text,Image,StyleSheet,Dimensions,FlatList, ScrollView, TouchableOpacity,Linking,Platform,PermissionsAndroid } from 'react-native';
...
const Home = () => {
  ...
  const data = [
    ...
    {id:3,image:require('../assets/carwash2.png'),name:'Waterless Cleaning'},
  ...
  const data1 = [
    {id:1,image:require('../assets/service.png'),name:'Basic Service',amount:'2,599',},
    {id:2,image:require('../assets/service.png'),name:'Underbody',name:'Basic Service',amount:'2,599',},
...
.catch((error) =>{
  ...
  const Item1 = ({item}) =>{
    return(
      <View style={{margin:10,alignSelf:'center',flex:1,backgroundColor:'#FFFFFF',borderRadius:5}}>
        ...
        <TouchableOpacity style={{margin:5,borderWidth:0.5,borderRadius:10,borderColor:COLORS.black,width:70,marginLeft:10}}>
          <Text style={{alignSelf:'center'}}>+9 more</Text>
        </TouchableOpacity>
        <View style={{margin:10,flexDirection:'row',justifyContent:'space-between'}}>
        <Text style={{fontSize:20,color:COLORS.black,fontWeight:'bold',}}> ₹ {item.amount}</Text>
        <TouchableOpacity style={{backgroundColor:COLORS.blue,borderRadius:5,width:50,padding:5}}>
  ...
  return (
    <View style={{flex:1}}>
      ...
      <View style={{padding:10,backgroundColor:COLORS.blue,}}>
        <View style={{flexDirection:'row',marginTop:10}}>
           <Entypo
                ...
                size={20}
                color={COLORS.white}
                style={{backgroundColor:'#FFFFFF4D',alignSelf:'center',borderRadius:2,padding:3,margin:5}}
              />
              ...
              {/* <Text style={{color:COLORS.white}}>3/5-10,Mehdipatnam, Hyderabad</Text> */}
                 {error == 2 ? (
                  <TouchableOpacity onPress={()=>{
                   ...
                   <Text style={{color:COLORS.white,width:250,fontSize:10}}>{location}</Text>
                 )}
              </View>
      ...
      <View style={{flex:1}}>
        <ScrollView>
      <Text style={{margin:10,color:COLORS.black,fontSize:17,fontWeight:'bold'}}>#SpecialForYou</Text>
      <View style={{marginLeft:10}}>
        <SwiperFlatList
          autoplay
          autoplayDelay={3}
      ...
      <View style={{alignSelf:'center',flex:1}}>
         ...
         <AntDesign
                ...
                style={{margin:5}}
              />
              <Text style={{color:COLORS.black,marginLeft:10,fontWeight:'bold',margin:5}}>Recommended for you</Text>
              <View  style={{alignSelf:'center',flex:1,marginRight:10}}>
              <Text style={{color:COLORS.orange,alignSelf:'flex-end',}}>See all</Text>
              </View>
         </View>
         <View style={{alignSelf:'center',flex:1,}}>
         <FlatList
